...
public class TheaterEJB {
    ...
    public List<Theater> getAll() {
        TypedQuery<Theater> query = em.createNamedQuery("Theater.findAll", Theater.class);
        return query.getResultList();
    }

    public List<Theater> getByZip(String zip) {
        TypedQuery<Theater> query = em.createNamedQuery("Theater.findByZip", Theater.class);
        return query.setParameter("addrzip", zip).getResultList();
    }
    
    public Theater get(long id) {
        TypedQuery<Theater> query = em.createNamedQuery("Theater.findById", Theater.class);
    ...
    public List<Showtime> getShowtimesByTheaterId(long id) {
        TypedQuery<Showtime> query = em.createNamedQuery("Theater.getShowtimesByTheaterId", Showtime.class);
        query.setParameter("id", id);
    ...
    public void clear(){
        em.createQuery("DELETE FROM Theater t").executeUpdate();
    }
}
